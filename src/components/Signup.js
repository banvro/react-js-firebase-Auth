  ...
  return (
    <>
      ...
      <div className='col-lg-12 for height' >
        <form class="row g-3 needs-validations" onSubmit={handleSubmit} novalidate>
          ...
          <div class="d-grid gap-3 col-12 mx-auto">
            <button class="btn1" id='google' onClick={handleClick} className="rounded-pill" type="button">
